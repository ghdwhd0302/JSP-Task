...
<!--     <form action="Member" name="regform" id="regform" method="post" onsubmit="return sendit()">
 -->    <form action="Member" name="regform" id="regform" method="post" onsubmit="return sendit()">
        ...
        <p>
            아이디: 
            <input type="text" name="userid" id="userid" maxlength="20" onkeydown="idModify()">
        ...
        <p>
            성별: 
            <label>
                남자 <input type="radio" name="gender" id="gender" value="남자" checked>
            </label>
            <label>
        ...
        <p>
        	주민등록번호:
        	<input type="text" name="ssn1" > - <input type="text"  name="ssn2">
        </p>
        <p>
            우편번호:
            <input type="text" name="zipcode" maxlength="5" id="sample6_postcode">
