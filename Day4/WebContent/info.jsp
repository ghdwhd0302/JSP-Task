...
<!--     <form action="Member" name="regform" id="regform" method="post" onsubmit="return sendit()">
 -->    <form action="Info" name="regform" id="regform" method="post" onsubmit="return sendit()">
        ...
        <p>
            이름: 
            <input type="text" name="name" id="name" value="<%=mem_name %>">
        </p>
        <p>
            휴대폰번호:
            <input type="text" name="hp" id="hp" value="<%=mem_hp %>">
        </p>
        <p>
            이메일:
            <input type="text" name="email" id="email" value="<%=mem_email %>">
        </p>
        <%-- <p>
            성별: 
            <label>
                남자 <input type="radio" name="gender" id="gender" value="남자" 
                <% if(mem_gender.equals("남자")) out.print("checked"); %>>
            </label>
            <label>
                여자 <input type="radio" name="gender" id="gender" value="여자"
                <% if(mem_gender.equals("여자")) out.print("checked"); %>>
            </label>
        </p> --%>
        <p>성별: 
        ...
        <p>
            우편번호:
            <input type="text" name="zipcode" maxlength="5" id="sample6_postcode" value="<%=mem_zipcode %>">
            <button type="button"  onclick="sample6_execDaumPostcode()">검색</button>
        </p>
        <p>
            주소:
            <input type="text" name="address1" id="sample6_address" value="<%=mem_address1 %>">
        </p>
        <p>
            상세주소:
            <input type="text" name="address2" id="sample6_detailAddress" value="<%=mem_address2 %>">
        </p>
        <p>
            참고항목:
            <input type="text" name="address3" id="sample6_extraAddress" value="<%=mem_address3 %>">
        </p>
        <p>
            <button>수정완료</button>
